...
class ForageableViewModel(private val forageableDao: ForageableDao): ViewModel() {
    ...
    val allForageables: Flow<List<Forageable>> = forageableDao.getForageables()
    ...
    fun addForageable(name: String, address: String, inSeason: Boolean, notes: String) {
        val forageable = Forageable(name = name,
            address = address,
            inSeason = inSeason,
            notes = notes)
        // Done: launch a coroutine and call the DAO method to add
        // a Forageable to the database within it
    ...
    fun updateForageable(id: Long, name: String, address: String, inSeason: Boolean, notes: String
        ...
        val forageable = Forageable(id = id,
            name = name,
            address = address,
            inSeason = inSeason,
            notes = notes)
